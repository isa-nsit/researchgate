...
ActiveRecord::Schema.define(version: 20180127220417) do
  ...
  add_index "incharges", ["email"], name: "index_incharges_on_email", unique: true
  add_index "incharges", ["reset_password_token"], name: "index_incharges_on_reset_password_token", unique: true
